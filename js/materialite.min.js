    ...
    s = function() {
        ...
        function n(i, n) {
            ...
            if (n) s(i, n) || l.push(e(n));
                ...
                var o = i.classList;
                h.forEach(function(e) { o.contains(e.cssClass) && l.indexOf(e) === -1 && !s(i, e.className) && l.push(e) })
            }
            for (var r, _ = 0, d = l.length; _ < d; _++) {
                ...
                var m;
                "CustomEvent" in window && "function" == typeof window.CustomEvent ? m = new CustomEvent("mdl-componentupgraded", { bubbles: !0, cancelable: !1 }) : (m = document.createEvent("Events"), m.initEvent("mdl-componentupgraded", !0, !0)), i.dispatchEvent(m)
            }
        }
        ...
        function _(e) {
            if (e) {
                ...
                var n;
                "CustomEvent" in window && "function" == typeof window.CustomEvent ? n = new CustomEvent("mdl-componentdowngraded", { bubbles: !0, cancelable: !1 }) : (n = document.createEvent("Events"), n.initEvent("mdl-componentdowngraded", !0, !0)), e.element_.dispatchEvent(n)
            }
        }
